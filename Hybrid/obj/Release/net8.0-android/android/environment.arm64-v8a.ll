...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 732, ; uint32_t number_of_dso_cache_entries (0x2dc)
	i32 33555252, ; uint32_t android_runtime_jnienv_class_token (0x2000334)
	i32 100671595, ; uint32_t jnienv_initialize_method_token (0x600206b)
	i32 100671594, ; uint32_t jnienv_registerjninatives_method_token (0x600206a)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [732 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.75_name, ; name: libaot-System.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.64_name, ; name: libaot-Microsoft.Win32.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 33
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1169479614495458075, ; hash 0x103ad3836210031b, from name: aot-Hybrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.107_name, ; name: libaot-System.Security.Claims.dll.so
		ptr null; void* handle (0x0)
	}, ; 42
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3161362433633973205, ; hash 0x2bdf6a623f0473d5, from name: libaot-RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 110
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Numerics.dll.so
		ptr null; void* handle (0x0)
	}, ; 130
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.60_name, ; name: libaot-Xamarin.Essentials.dll.so
		ptr null; void* handle (0x0)
	}, ; 188
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7667640967838332169, ; hash 0x6a68eed5d93c7509, from name: Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 7996916684280368070, ; hash 0x6efac15ad8ed0bc6, from name: RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 292
	...
	%struct.DSOCacheEntry {
		i64 8851320950581818696, ; hash 0x7ad635821c66f548, from name: libaot-Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 8903038456932946670, ; hash 0x7b8df24e672152ee, from name: libaot-Hybrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 342
	...
	%struct.DSOCacheEntry {
		i64 10321540080188499283, ; hash 0x8f3d7a045e97a553, from name: libaot-RCL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 10438878014926254369, ; hash 0x90de583f3d507121, from name: RCL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 402
	...
	%struct.DSOCacheEntry {
		i64 13855863199260417157, ; hash 0xc049ea2b10531c85, from name: Hybrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 553
	...
	%struct.DSOCacheEntry {
		i64 14427117617325927282, ; hash 0xc8376b08e97deb72, from name: aot-RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 585
	...
	%struct.DSOCacheEntry {
		i64 17616811395327538819, ; hash 0xf47b7ca04d8d3683, from name: aot-RCL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 697
	...
	%struct.DSOCacheEntry {
		i64 18328424554462404942, ; hash 0xfe5ba5062d47614e, from name: aot-Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 727
...
@.env.3 = private unnamed_addr constant [37 x i8] c"8c6800a7-7fd2-4105-a454-a3156f409596\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.hybrid\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [18 x i8] c"libaot-RCL.dll.so\00", align 1
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-Hybrid.dll.so\00", align 1
...
@.DSOCacheEntry.33_name = private unnamed_addr constant [29 x i8] c"libaot-MySqlConnector.dll.so\00", align 1
...
@.DSOCacheEntry.60_name = private unnamed_addr constant [33 x i8] c"libaot-Xamarin.Essentials.dll.so\00", align 1
...
@.DSOCacheEntry.64_name = private unnamed_addr constant [41 x i8] c"libaot-Microsoft.Win32.Primitives.dll.so\00", align 1
...
@.DSOCacheEntry.75_name = private unnamed_addr constant [26 x i8] c"libaot-System.Core.dll.so\00", align 1
...
@.DSOCacheEntry.96_name = private unnamed_addr constant [30 x i8] c"libaot-System.Numerics.dll.so\00", align 1
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [37 x i8] c"libaot-System.Security.Claims.dll.so\00", align 1
