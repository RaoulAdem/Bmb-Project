...
@dso_cache = dso_local local_unnamed_addr global [732 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 253130371, ; hash 0xf167683, from name: RCL.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 314465820, ; hash 0x12be5e1c, from name: Hybrid.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1420119549, ; hash 0x54a54dfd, from name: Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 233
	...
	%struct.DSOCacheEntry {
		i64 1474490617, ; hash 0x57e2f0f9, from name: RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 1727635610, ; hash 0x66f9a09a, from name: aot-Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 2750314034, ; hash 0xa3ee7632, from name: aot-RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
	%struct.DSOCacheEntry {
		i64 2753175945, ; hash 0xa41a2189, from name: libaot-Hybrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
	...
	%struct.DSOCacheEntry {
		i64 3136730470, ; hash 0xbaf6b566, from name: aot-Hybrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 546
	...
	%struct.DSOCacheEntry {
		i64 3335558661, ; hash 0xc6d09605, from name: libaot-RCL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 576
	...
	%struct.DSOCacheEntry {
		i64 3512604603, ; hash 0xd15e17bb, from name: libaot-Hybrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Hybrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 601
	...
	%struct.DSOCacheEntry {
		i64 3844180185, ; hash 0xe52188d9, from name: aot-RCL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 655
	%struct.DSOCacheEntry {
		i64 3880179575, ; hash 0xe746d777, from name: libaot-RCL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RCL.dll.so
		ptr null; void* handle (0x0)
	}, ; 656
